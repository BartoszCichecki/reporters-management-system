 ...
 */
public class AccountDeletedAuthenticationEventListener extends AbstractAuthenticationEventListener<AuthenticationFailureDisabledEvent> {

	@Override
	public void onApplicationEvent(AuthenticationFailureDisabledEvent event) {
		log(event, AuthenticationStatus.AUTHENTICATION_ACCOUNT_DELETED);
	}
