...
public enum PrivilegeType {
	...
	CLEAN_UP_MESSAGES, CREATE_DEVICES, CREATE_ROLES, CREATE_USERS, DELETE_ACCESS_HISTORY, DELETE_DEVICES, DELETE_EVENTS,
	DELETE_MESSAGES, DELETE_MY_EVENTS, DELETE_ROLES, DELETE_USERS, LOOK_UP_DEVICE_EVENTS, LOOK_UP_ROLE_USERS, LOOK_UP_USER_ROLES,
	MANAGE_ACCESS_HISTORY, MANAGE_DEVICES, MANAGE_EVENTS, MANAGE_MESSAGES, MANAGE_PROFILE, MANAGE_ROLES, MANAGE_USERS,
	MARK_DELETE_DEVICES, MARK_DELETE_MESSAGES, MARK_DELETE_MY_EVENTS, POST_EVENTS, POST_EVENTS_TO_WAITING_ROOM, SEND_MESSAGES, SIGN_UP_FOR_EVENT,
	UPDATE_DEVICES, UPDATE_MY_EVENTS, UPDATE_OUTGOING_MESSAGES, UPDATE_ROLES, UPDATE_USERS, VIEW_ACCESS_HISTORY, VIEW_DEVICES, VIEW_EVENTS,
	VIEW_MESSAGES, VIEW_PROFILE, VIEW_ROLES, VIEW_USERS;
